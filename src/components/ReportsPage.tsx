    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="container mx-auto px-6 py-8 max-w-7xl">
        ...
        <div className="mb-8 bg-card border border-border rounded-lg p-6">
          <h2 className="text-xl font-semibold mb-4 text-foreground">📅 Time Period</h2>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-card border border-border rounded-lg p-6">
            <h3 className="text-xl font-semibold mb-4 text-foreground">📈 Monthly Trend (Last 12 Months)</h3>
            <div className="h-80">
          ...
          <div className="bg-card border border-border rounded-lg p-6">
            <h3 className="text-xl font-semibold mb-4 text-foreground">💊 Income vs Expenses (Last 12 Months)</h3>
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 mb-8">
          ...
          {expenseData.length > 0 && (
            <div className="bg-card border border-border rounded-lg p-6">
              <h3 className="text-xl font-semibold mb-4 text-foreground">💳 Expense Categories</h3>
              <div className="h-80">
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    <Pie
          ...
          {incomeData.length > 0 && (
            <div className="bg-card border border-border rounded-lg p-6">
              <h3 className="text-xl font-semibold mb-4 text-foreground">💰 Income Categories</h3>
              <div className="h-80">
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    <Pie
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
          ...
          <div className="bg-card border border-border rounded-lg p-6">
            <h3 className="text-xl font-semibold mb-4 text-foreground">📊 Category Breakdown</h3>
                  ...
                  {filteredTransactions
                    ...
                    .map((transaction) => (
                      <tr key={transaction.id} className="border-b border-border">
                        <td className="py-2 text-muted-foreground">{format(new Date(transaction.date), 'MMM dd')}</td>
                        <td className="py-2 text-foreground truncate max-w-0" title={transaction.note}>
                          {transaction.note}
                        </td>
