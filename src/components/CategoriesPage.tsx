        ...
        {filteredCategories.length === 0 ? (
          <div className="text-center py-16 border border-gray-800 rounded-lg bg-gray-900/30">
            {filterType === 'ALL' ? (
              ...
              <>
                <p className="text-gray-400 text-lg">No {filterType.toLowerCase()} categories found</p>
                <p className="text-gray-500 text-sm mt-1">Create your first {filterType.toLowerCase()} category to get started</p>
              </>
            )}
          </div>
        ) : (
